...
export const goose_models: Model[] = [
  ...
  { id: 18, name: 'gpt-4o', provider: 'Omg' },
  { id: 19, name: 'claude-3-5-sonnet', provider: 'Omg' },
];
...
export const omg_models = ['gpt-4o', 'claude-3-5-sonnet'];
...
export const model_docs_link = [
  ...
  { name: 'Omg', href: 'https://docs.ohmygpt.com' },
];
